                ...
                <v-card-text>
                  <v-container>
                    <v-row>
                      ...
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="runningStartTime" label="시작시간" type="time" step="3600" value="08:00" hint="시간단위로 설정됩니다."
                          required></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="runningEndTime" label="종료시간" type="time" step="3600" value="08:00" hint="시간단위로 설정됩니다."
                          required></v-text-field>
                      </v-col>
                      <v-col cols="12">
                        <v-text-field v-model="runningDetails" label="강의내용" hint="Learner에게 강의할 내용을 간략하게 적어주세요" required></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6">
